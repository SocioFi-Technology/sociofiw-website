      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-xl mb-10 text-white/90">
            Discover the power of intelligent assistance and community building with AI Chatbot BB. Contact us today to
            learn more about our pricing plans and how BB can benefit your organization in Bangladesh.
          </motion.p>
