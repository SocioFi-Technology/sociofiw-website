    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-gradient-to-b from-white to-neutral-offwhite">
      ...
      <div className="container mx-auto px-4 z-10 py-20">
        ...
        >
          ...
          >
            Strategic AI Consulting to Unlock Your Business Potential
          </motion.h1>
          ...
          <motion.h3 variants={itemVariants} className="text-xl md:text-2xl mb-6 text-neutral-darkgrey">
            Our expert consultants provide the guidance and support you need to successfully integrate AI into your
            organization.
          </motion.h3>

          <motion.p variants={itemVariants} className="text-lg mb-10 text-gray-700">
            Navigating the complex world of AI can be challenging. At SocioFi Technology, our consultancy services help
            businesses in Bangladesh understand how AI can address their specific challenges, develop effective
            implementation strategies, and maximize the return on their AI investments. Whether you're just beginning
            your AI journey or looking to optimize existing initiatives, our expert consultants provide the guidance and
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <Link href="#consultancy-expertise">Explore Our Services</Link>
            </Button>
          </motion.div>
        </motion.div>
      </div>
