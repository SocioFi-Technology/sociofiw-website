    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-gradient-to-b from-white to-neutral-offwhite">
      ...
      <div className="container mx-auto px-4 z-10 py-20">
        ...
        >
          ...
          >
            Empowering the Future: SocioFi's Incubation Program for AI Entrepreneurs
          </motion.h1>
          ...
          <motion.h3 variants={itemVariants} className="text-xl md:text-2xl mb-6 text-neutral-darkgrey">
            We provide the resources, mentorship, and support young talents need to build groundbreaking AI products in
            Bangladesh.
          </motion.h3>

          <motion.p variants={itemVariants} className="text-lg mb-10 text-gray-700">
            SocioFi Technology's Incubation Program is designed to nurture the next generation of AI entrepreneurs in
            Bangladesh. We believe in the immense potential of local talent to create innovative AI solutions that
            address both local and global challenges. Through our program, we provide comprehensive support to help turn
            promising ideas into successful AI-powered businesses, contributing to Bangladesh's growth as a hub for
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <Link href="#program-overview">Learn More</Link>
            </Button>
          </motion.div>
        </motion.div>
      </div>
